...
export const Input = ({ attachmentButtonProps, attachmentCircularActivityIndicatorProps, isAttachmentUploading, onAttachmentPress, onSendPress, sendButtonVisibilityMode, textInputProps, }) => {
    ...
    return (React.createElement(View, { style: container },
        ...
        React.createElement(TextInput, { multiline: false, returnKeyType: "send", onSubmitEditing: handleSend, placeholder: l10n.inputPlaceholder, placeholderTextColor: `${String(theme.colors.inputText)}80`, underlineColorAndroid: 'transparent', ...textInputProps, 
