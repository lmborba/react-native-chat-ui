...
export const SendButton = ({ onPress, touchableOpacityProps, }) => {
    ...
    return (React.createElement(TouchableOpacity, { accessibilityLabel: l10n.sendButtonAccessibilityLabel, accessibilityRole: 'button', ...touchableOpacityProps, onPress: handlePress, style: styles.sendButton }, (_c = (_b = (_a = theme.icons) === null || _a === void 0 ? void 0 : _a.sendButtonIcon) === null || _b === void 0 ? void 0 : _b.call(_a)) !== null && _c !== void 0 ? _c : (React.createElement(Image, { source: require('../../assets/icon-send.png'), style: { tintColor: theme.colors.inputText, width: 24, height: 24 } }))));
};
